...
string changeRoom(string room)
{
    ...
    while (true)
    {
        ...
        {
            cout << "Invalid entry. Please enter a number between zero and " << roomList.size() - 1;
        }
...
int actionMenu(string room)
{
    ...
    while (true)
    {
        ...
        if (ans == 2)
        {
            cout << "Work in progress. Check back later";
        }
        ...
        if (ans == 4)
        {
            cout << "You have currently solved " << roomSolves.size() << " room(s)";
        }
